...
class SessionSidebar(QWidget):
    ...
    def _setup_ui(self):
        ...
        # Agent Network 按钮
        agent_network_btn = QPushButton("🤖 Agent Network")
        agent_network_btn.setStyleSheet("""
            QPushButton {
        ...
        """)
        agent_network_btn.clicked.connect(self.agent_network_clicked.emit)
        layout.addWidget(agent_network_btn)
